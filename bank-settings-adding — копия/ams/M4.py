...
from config import EMAIL, PASSWORD, CUSTOMER, RESTAURANT, API_PROXY_PASSWORD, M4
    ...
    def edit_all_devices_on_location(self):
        ...
        for i in range(0, 12):
            ...
            def edit_device():
                ...
                bank_settings_block = form.find_element(By.CSS_SELECTOR,
                                                        'div[data-test="BankSettingsBlock"]')

                single_bank_settings_block = bank_settings_block.find_element(By.CLASS_NAME, 'U05rEvagThTt83mk8RuDu')

                sbp_terminal_id_block = single_bank_settings_block.find_element(By.CSS_SELECTOR,
                                                       'div[data-test="TerminalIdField"]')
                sbp_terminal_id_input = sbp_terminal_id_block.find_element(By.CLASS_NAME, 'ant-input')
                ...
                time.sleep(0.5)
                sbp_terminal_id_input.click()

                actions.send_keys(Keys.TAB).perform()
                actions.send_keys(Keys.TAB).perform()

                actions.send_keys(M4).perform()
                ...
                actions.send_keys(Keys.TAB).perform()
                actions.send_keys(API_PROXY_PASSWORD).perform()
